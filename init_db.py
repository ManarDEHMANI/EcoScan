...
etiquettes = [
    {
        ...
        "harmfulness": "High sugar content can contribute to tooth decay, weight gain, and blood sugar spikes. Excessive consumption may increase risk of type 2 diabetes and provide empty calories without fiber benefits of whole fruits.",
    },
    {
        "tag": "water",
        ...
        "harmfulness": "Generally safe, but inadequate intake leads to dehydration. Contaminated water can cause serious illness. Excessive consumption in rare cases may lead to water intoxication.",
    },
    {
        "tag": "milk",
        ...
        "harmfulness": "Can cause digestive issues in lactose intolerant individuals. Full-fat versions are high in saturated fat. Raw/unpasteurized milk may contain harmful bacteria.",
    },
    {
        "tag": "soft-drink",
        ...
        "harmfulness": "Extremely high in sugar, leading to obesity, diabetes, and tooth decay. Contains phosphoric acid that can weaken bones. Diet versions have artificial sweeteners with debated health impacts.",
    },
    {
        "tag": "cleaning",
        ...
        "harmfulness": "Highly toxic if ingested. Can cause chemical burns to skin/eyes. Fumes may cause respiratory issues. Mixing different cleaners can create dangerous gases.",
    },
    {
        "tag": "washing",
        ...
        "harmfulness": "Can cause severe skin irritation and chemical burns. Toxic if swallowed. May release harmful fumes. Environmental concerns with phosphates and chemicals.",
    },
   {
        "tag": "alcohol",
        ...
        "harmfulness": "Can lead to addiction, liver disease, and increased cancer risk. Impairs judgment and coordination. Long-term abuse affects brain function and mental health.",
    },
    {
        "tag": "oil",
        ...
        "harmfulness": "High in calories, excessive consumption leads to weight gain. When heated to high temperatures can release harmful compounds. Rancid oils contain harmful free radicals.",
    },
